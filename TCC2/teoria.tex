...
O emaranhamento quântico é uma das propriedades mais estranhas e intrigantes da mecânica quântica e tem implicações importantes, por exemplo, a comunicação quântica utiliza o emaranhamento quântico para transmitir informações de forma segura, pois qualquer tentativa de interceptar a comunicação alteraria o estado emaranhado e seria detectável.
...
O Paradoxo EPR é um famoso argumento em favor da incompletude da mecânica quântica, proposto por Albert Einstein, Boris Podolsky e Nathan Rosen em 1935. O paradoxo começa com a observação de que a mecânica quântica prevê que duas partículas emaranhadas podem estar em um estado quântico compartilhado, mesmo que estejam distantes uma da outra.

De acordo com a mecânica quântica, se duas partículas são emaranhadas, a medição do estado quântico de uma partícula instantaneamente afetará o estado quântico da outra partícula, independentemente da distância entre elas. Isso significa que as partículas emaranhadas parecem estar em comunicação instantânea, o que violaria a teoria da relatividade especial de Einstein, que proíbe a comunicação mais rápida do que a velocidade da luz.
...
A resolução do paradoxo EPR veio da teoria da mecânica quântica e sua interpretação correta. A mecânica quântica não viola a relatividade especial de Einstein, pois as partículas emaranhadas não estão realmente em comunicação instantânea. Em vez disso, o estado quântico das partículas emaranhadas é uma superposição de estados possíveis, e a medição do estado de uma das partículas colapsa a função de onda do sistema emaranhado como um todo, fazendo com que o estado da outra partícula pareça estar sendo afetado instantaneamente. A explicação correta é que a medição da primeira partícula, que afeta instantaneamente a segunda partícula, não é uma ação física, mas sim uma consequência da natureza probabilística da mecânica quântica.


\subsection{Teletransporte Quântico}\label{sec:teletransporteteoria}

O teletransporte quântico de informação é um protocolo que permite transferir o estado quântico de um qubit de um local para outro sem que o próprio qubit seja enviado fisicamente. Esse protocolo é baseado na propriedade da entrelaçamento quântico, que permite que dois qubits estejam correlacionados de tal forma que a medição do estado de um afeta instantaneamente o estado do outro, mesmo que estejam fisicamente distantes.

Ele é desenvolvido em três etapas: o remetente (Alice), o destinatário (Bob) e um canal clássico de comunicação. O remetente Alice possui um qubit que deseja teletransportar para Bob, que está fisicamente distante. Alice também possui outro qubit emaranhado com o qubit que deseja teletransportar.

O processo começa com Alice aplicando uma série de operações quânticas em ambos os qubits emaranhados, que os colocam em um estado de entrelaçamento particular. Em seguida, Alice faz uma medição conjunta do estado dos dois qubits emaranhados e envia o resultado da medição por meio do canal clássico de comunicação para Bob.

A partir do resultado da medição recebida, Bob aplica uma série de operações quânticas ao seu qubit e consegue recriar o estado original do qubit de Alice, que foi teletransportado para ele. Vale ressaltar que o próprio qubit de Alice não é enviado para Bob, apenas as informações quânticas necessárias para reconstruir o estado do qubit são transmitidas.

O teletransporte quântico de informação é um protocolo importante na área de comunicação quântica e pode ser usado para a transferência segura de informações quânticas entre duas partes distantes. Isso ocorre porque o estado do qubit teletransportado não é acessível a nenhum observador intermediário, devido à natureza probabilística da mecânica quântica.
...
\section{Operadores Quânticos}\label{sec:opquantico}
...
\section{Protocolo de Teletransporte Quântico}\label{sec:teletransporteprotocolo}
...
\section{Algoritmo do protocolo de Teletransporte}\label{sec:algoritmo}
...
~
Para implementar um protocolo de teletransporte quântico usando sympy e numpy, é necessário primeiro entender os conceitos básicos da mecânica quântica e do teletransporte quântico.

O teletransporte quântico é uma técnica que permite a transmissão de um estado quântico de um sistema para outro distante sem a necessidade de transporte físico. O protocolo de teletransporte quântico é baseado na propriedade de emaranhamento quântico, que permite a correlação instantânea entre duas partículas, independentemente da distância entre elas.

O protocolo de teletransporte quântico envolve três qubits: o qubit a ser teletransportado, o qubit de emaranhamento e o qubit de medição. O qubit de emaranhamento é criado inicialmente em um estado de emaranhamento, e um dos qubits é enviado para o destinatário, enquanto o outro permanece com o remetente. O qubit a ser teletransportado é então combinado com o qubit remanescente do emaranhamento, e uma medida é realizada nos dois qubits resultantes. Com base no resultado da medição, é possível inferir o estado do qubit original e reconstruí-lo no qubit de destino.
